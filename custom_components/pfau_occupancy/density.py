...
comparable across clubs and more realistic for a "busyness" sensor.
...
and machines themselves - dead space that shouldnt count for how busy a club feels.
...
Thresholds are in people per 36 square metres of that effective area — a 6m
by 6m square. More human friendly and easier to visualise in your head. By default,
up to two people per 36m2 is considered quiet, up to four is busy, and six or more
is crowded.
...
def measure_density(
    ...
    return DensityReading(
        people_per_36sqm=round(density, 4),
